...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <fieldUpdates>
        <fullName>Set_Case_to_Escalated_New</fullName>
        <field>IsEscalated</field>
        <literalValue>1</literalValue>
        <name>Set Case to Escalated</name>
        <notifyAssignee>false</notifyAssignee>
    ...
    <rules>
        ...
        <actions>
            <name>Set_Case_to_Escalated_New</name>
            <type>FieldUpdate</type>
        </actions>
        <actions>
            <name>Follow_Up_on_Escalated_Case_New</name>
            <type>Task</type>
        </actions>
        <active>true</active>
        <criteriaItems>
    ...
    <tasks>
        <fullName>Follow_Up_on_Escalated_Case_New</fullName>
